 ...
 *
 * NAME:        amiq_i2c_ex_ms_test_reserved_addr.e
 * PROJECT:     amiq_i2c
 * Description: This file contains the declaration of the reserved address test used in
...
extend MAIN amiq_i2c_ex_virtual_seq {
   !master_transfer : MASTER_RESERVED amiq_i2c_ex_virtual_seq;
