 ...
 *
 * NAME:        amiq_i2c_ex_ms_test_general_call.e
 * PROJECT:     amiq_i2c
 * Description: This file contains the declaration of the general call test used in
...
extend SLAVE amiq_i2c_agent_config_u {
   keep en_general_call == TRUE;
};

extend MAIN amiq_i2c_ex_virtual_seq {
   !master_transfer : MASTER_GENERAL_CALL amiq_i2c_ex_virtual_seq;
